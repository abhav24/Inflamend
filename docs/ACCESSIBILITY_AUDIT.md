...
| Today/Home | Partial | Unverified | Likely acceptable | Mostly >=44pt; check-in, timeline edit, and timeline delete confirmation paths verified | Safety card, edit sheet, and delete confirmation use text | In progress |
