...
What remains:
- Add undo affordances, structured edit fields, and richer per-record history.
...
What remains:
- Add undo affordances and richer per-record history.
