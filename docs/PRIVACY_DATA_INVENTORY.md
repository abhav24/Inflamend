...
- Local IBD Library guides are static source-attributed app content and are not persisted as user data in this checkpoint. Future bookmarks, notes, viewed-article analytics, or personalized education recommendations should be treated as health-adjacent data and reviewed before sync or telemetry.
