...
- Typed `HealthLogPayload` fields store structured symptom, bowel, food-tag, medication, sleep, weight, note, and voice-parsed data locally and in JSON exports. Snapshot-backed medication dose schedules/statuses and medication reminder preferences also store medication adherence-related state locally and in JSON exports. Treat these fields as health data or health-adjacent settings; live sync, AI context, production diagnostics, notifications, and cloud exports require privacy review before use.
